...
export default function Login() {
  ...
  return (
    <section className="h-screen w-full bg-gradient-to-r from-[#1e3b8c] to-[#2562e9] relative overflow-hidden">
      ...
      <div className="bg-white w-[40%] h-[45%] my-12 mx-auto rounded-lg shadow-2xl relative z-50">
        ...
        <form className="px-10">
          <Input placeholder="Type your username." className="mb-5"></Input>
          <Input placeholder="Type your password." type="password"></Input>
          <Button className="bg-[#2562e9] text-white font-bold outline-none block mx-auto w-full my-5">
            Sign In
          </Button>
        </form>
